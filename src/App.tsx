    ...
    <QueryClientProvider client={queryClient}>
      <TooltipProvider>
        <Helmet>
          ...
          <meta name="description" content="Dubai's #1 trusted platform for buying and selling used TVs. Samsung, LG, Sony & all brands. Instant cash, free pickup, same-day service. Call +971 50 123 4567." />
          ...
          <link rel="canonical" href="https://usedtvdubai.ae/" />
        </Helmet>
        <Toaster />
        <Sonner />
        <BrowserRouter>
