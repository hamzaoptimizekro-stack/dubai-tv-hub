      ...
      <section className="section-padding">
        <div className="container container-narrow prose-seo">
          ...
          <ul>
            ...
            <li>The return must be initiated by contacting us at +971 50 123 4567.</li>
          </ul>
          ...
          <h2>Contact Us</h2>
          <p>For return or refund inquiries, contact us at info@usedtvdubai.ae or call +971 50 123 4567.</p>
        </div>
      </section>
    </>
  );
